...
def test_retina_head_forward_single():
    ...
    feat = paddle.rand(1, retina_model.in_channels, 32, 32)
...
def test_retina_head_forward():
    ...
    feats = [
        paddle.rand(1, retina_model.in_channels, s // (2**(i + 2)),
                   s // (2**(i + 2)))  # [32, 16, 8, 4, 2]
...
def test_retinanet_head_get_bboxes():
    ...
    # where each torch.Tensor is generated by paddle.rand().
...
def test_yolov3_head_forward():
    ...
    feats = [
        paddle.rand(1, 1, 64 // (2**(i + 2)), 64 // (2**(i + 2)))
...
def test_fcos_head_forward_single():
    ...
    feat = paddle.rand(1, fcos_model.in_channels, 32, 32)
...
def test_fcos_head_get_bboxes():
    ...
    cls_scores = [
        paddle.rand(1, fcos_model.num_classes, s // feat_size, s // feat_size)
        for feat_size in [4, 8, 16, 32, 64]
    ]
    bboxes = [
        paddle.rand(1, 4, s // feat_size, s // feat_size)
        for feat_size in [4, 8, 16, 32, 64]
    ]
    centerness = [
        paddle.rand(1, 1, s // feat_size, s // feat_size)
...
def test_fsaf_head_forward_single():
    ...
    feat = paddle.rand(1, fsaf_model.in_channels, 32, 32)
...
def test_fsaf_head_forward():
    ...
    s = 128
    feats = [
        paddle.rand(1, fsaf_model.in_channels, s // (2**(i + 2)),
                   s // (2**(i + 2)))
...
def test_ssd_head_forward():
    ...
    feats = [
        paddle.rand(1, ssd_model.in_channels[i], featmap_size[i],
